...
Python architecture analysis: import graph, cycles, layer rules, five-axis score, refactor-priority hotspots, DSM, and an MCP server (11 tools) so coding agents see structural impact before they commit.
