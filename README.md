...
| House style | `archy conventions` (naming families by home module, mirrored surfaces, a gate inventory kept separate from user-error exits, model census - derived from the source, so an agent stops guessing conventions; advisory, always exits 0) |
